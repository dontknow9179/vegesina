...
def data_log(start, end):
    ...
    Mongodb_Port = 27017
    con = MongoClient(Mongodb_Host, Mongodb_Port)
    db = con[Mongodb_Database_Name]
    collection = db['article20190422'].find({})
    ...
    for article in collection :
        ...
        if i >= start and i <= end:
            svos = extractor.triples_main(article['title'])
            event_dict[i] = svos
...
#     extractor = TripleExtractor()
#     svos = extractor.triples_main(content3)
#     print('svos', svos)
#
# test()
